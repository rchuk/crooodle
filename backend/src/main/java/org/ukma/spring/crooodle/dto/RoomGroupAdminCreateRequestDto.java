...
@Builder
@Value
public class RoomGroupAdminCreateRequestDto {
    ...
    @Positive
    Long hotelId; // ID готелю, до якого належить група

    @Positive
    Long roomTypeId; // ID типу кімнат у цій групі

    AmenitiesEntity amenities; // Зручності для групи кімнат
}
